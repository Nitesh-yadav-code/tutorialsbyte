            ...
            <div className='main container flex flex-col-reverse md:flex-row '>
                <div className="content mt-20 md:mt-28">
                    <div className="main-head container  w-3/4 md:w-fit lg:w-3/4  m-auto md:m-0 md:ml-[5.4rem]">
                        ...
                        <p className='text-xl md:text-2xl xl:text-4xl p-2 md:p-4 font-medium'>The Ultimate Resource for Excelling in SDE Interviews</p>
                    </div>
                ...
                {/* <div className="image mt-10 w-[75%] md:w-[50%] ml-8 md:ml-0 ">
                    <Image src='/bg.png' alt="Image" width={500} height={500} />
                </div> */}
            </div>
